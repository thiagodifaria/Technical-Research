...
Write-Host "--- Configurando o projeto cpp com CMake ---" -ForegroundColor Cyan
...
# --- Compilação (Build) ---
Write-Host "--- Compilando os testes cpp ---" -ForegroundColor Green
# Compila o projeto na configuração Release. Isso irá gerar o run_tests.exe
cmake --build build --config Release

# --- Execução dos Testes ---
Write-Host "--- Executando os testes cpp diretamente ---" -ForegroundColor Magenta
...
Write-Host "--- Processo de teste cpp concluido com sucesso! ---" -ForegroundColor Green